...
impl OfficeSharedContent {
    ...
    pub fn replace_property_set(
        ...
        {
            let previous =
                std::mem::replace(&mut node.data, OfficePropertySetData::Parsed(validated));
    ...
    pub fn write_to_compound_file(
        ...
        let managed_paths = candidate
            ...
            .filter_map(|entry| {
                OfficePropertySetKind::from_stream_name(&entry.name)
...
fn parse_host_vba_project(
    ...
    let parsed = vba_storage
        ...
        .and_then(|storage| {
            LocatedVbaProject::from_compound_file_at_with_limits(
                compound,
                &storage.path,
                options.limits,
            )
...
mod tests {
    ...
    fn root_property_set_is_located_edited_and_reopened() {
        ...
        compound
            ...
            .unwrap();
        let mut shared = OfficeSharedContent::from_compound_file_with_options(
            &compound,
        ...
        shared
            ...
            .unwrap();
        let reopened = OfficeSharedContent::from_compound_file_with_options(
            &compound,
            ParseOptions::default(),
        )
        .unwrap();
    ...
    fn compatible_invalid_stream_requires_preserving_save() {
        ...
        compound
            ...
            .unwrap();
        assert!(
            OfficeSharedContent::from_compound_file_with_options(
                &compound,
                ParseOptions::default()
            )
            .is_err()
    ...
    fn nested_property_set_is_not_owned_by_host_root() {
        ...
        compound
            ...
            .unwrap();
        let shared = OfficeSharedContent::from_compound_file_with_options(
            &compound,
            ParseOptions::default(),
        )
        .unwrap();
